...
try
    call operator#user#define('clang-format', 'operator#clang_format#do', 'let g:operator_clang_format_save_pos = getpos(".") \| let g:operator#clang_format#save_screen_pos = line("w0")')
catch /^E117/
